...
export default function LibraryPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      <Link href="/dashboard" className="mb-2 inline-block text-sm text-slate-500 hover:text-slate-700">
        ← Dashboard
      </Link>
      <h1 className="mb-1 text-2xl font-bold text-slate-800">Library</h1>
        ...
        <ul className="space-y-2">
          {list.map((item) => (
            <li key={item.id} className="group">
              <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 shadow-sm transition hover:border-slate-300 hover:shadow">
                <Link
                ...
                >
                  <span className="flex items-center gap-2">
                    ...
                    {item.hasPassword && <Lock className="h-3.5 w-3.5 flex-shrink-0 text-slate-400" />}
                  </span>
                ...
                {item.publishedSlug && (
                  <a
                    ...
                    className="flex-shrink-0 rounded-md border border-slate-200 bg-slate-50 px-3 py-1.5 text-center text-sm font-medium text-slate-700 hover:bg-slate-100"
                ...
                {item.hasPassword && (
                  <button
                    ...
                    className="flex-shrink-0 rounded-md border border-slate-200 bg-white p-1.5 text-slate-400 transition hover:border-amber-200 hover:bg-amber-50 hover:text-amber-600 disabled:opacity-50"
                ...
                <div className="relative flex-shrink-0" ref={openMenuId === item.id ? menuRef : undefined}>
                  <button
                    ...
                    title="More options"
                    className="rounded-md border border-slate-200 bg-white p-1.5 text-slate-400 transition hover:border-slate-300 hover:bg-slate-50 hover:text-slate-600"
